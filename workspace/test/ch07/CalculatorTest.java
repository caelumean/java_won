...
public class CalculatorTest {
    ...
    void add(){
        ...
        if(result == 5){
            // 기대값 5, 기대값과 실제값을 비교해서 일치하면 성공, 아니면 실패
            System.out.println("두 정수의 덧셈 검증 성공");
        }else{
            System.err.println("덧셈의 결과는 5여야함");
    ...
    void divide(){
        ...
        if(result == 1.67){
            ...
            System.out.println("10/6은 1.67이 되어야 함" + result);
    ...
    void divide_byZero(){
        ...
        try{
            ...
            System.out.println("ArithmeticException이 발생하지 않으면 테스트 실패" + result);
